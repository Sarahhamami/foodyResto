    ...
    <div class="page">
                ...
                <div class="rd-navbar-right rd-navbar-nav-wrap">
                  ...
                  <div class="rd-navbar-main">
                    ...
                    <ul class="rd-navbar-nav">
                      ...
                      <li class="rd-nav-item active"><a class="rd-nav-link" href="sign_in.php">Sign-in</a>
                      </li>
                    </ul>
                  </div>
                </div>
      ...
      <section class="bg-gray-7">
        <div class="breadcrumbs-custom box-transform-wrap context-dark">
          <div class="container">
            <h3 class="breadcrumbs-custom-title">My Account</h3>
            <div class="breadcrumbs-custom-decor"></div>
          </div>
          <div class="box-transform" style="background-image: url(images/bg3.png)"></div>
        </div>
        <div class="container">
            ...
            <div class="col-lg-8">
              <ul class="list-xl box-typography">
                <li>
                  ...
                  <p>Welcome to our wonderful PizzaHouse. The journey is about to begin all you need is sign in to be able to order your Meal and to make Foody a happy place</p>
                  <form class="rd-form rd-mailform form-style-1" data-form-output="form-output-global" data-form-type="contact" method="post" action="bat/rd-mailform.php">
                    <div class="row row-20 gutters-20">
                      <div class="col-md-6 col-lg-4 oh-desktop">
                        <div class="form-wrap wow slideInDown">
                          <input class="form-input" id="contact-your-username-6" type="text" name="name" data-constraints="@Required">
                          <label class="form-label" for="contact-your-username-6">User Name*</label>
                        </div>
                        <div class="form-wrap wow slideInDown">
                          <input class="form-input" id="contact-your-firstname-6" type="text" name="first-name" data-constraints="@Required">
                          <label class="form-label" for="contact-your-firstname-6">First Name*</label>
                        </div>
                        <div class="form-wrap wow slideInDown">
                          <input class="form-input" id="contact-your-lastname-6" type="text" name="last-name" data-constraints="@Required">
                          <label class="form-label" for="contact-your-lastname-6">Last Name*</label>
                        </div>
                        <div class="form-wrap wow slideInDown">
                          <input class="form-input" id="contact-your-email-6" type="text" name="email" data-constraints="@Required">
                          <label class="form-label" for="contact-your-email-6">Email*</label>
                        </div>
                        </div>
                        
                        <div class="form-wrap wow slideInDown">
                        <label class="form-label" for="formFileLg">Profile Picture*</label>
                          <input class="form-control form-control-lg" id="formFileLg" type="file" accept="image/*" data-constraints="@Required">
                           

                          
                        <div class="form-wrap wow slideInDown">
                          <input class="form-input" id="contact-your-CIN-6" type="text" name="CIN" data-constraints="@Required">
                          <label class="form-label" for="contact-your-CIN-6">CIN*</label>
                        </div>

                        <div class="form-wrap wow slideInDown">
                          <input class="form-input" id="contact-your-cardNum-6" type="text" name="cardNum" data-constraints="@Required">
                          <label class="form-label" for="contact-your-cardNum-6">Card Number*</label>
                        </div>
                        <div class="form-wrap wow slideInDown">
                          <input class="form-input" id="contact-your-phonenum-6" type="text" name="PhoneNum" data-constraints="@Required">
                          <label class="form-label" for="contact-your-phonenum-6">Phone Number*</label>
                        </div>
                          <div class="form-wrap wow slideInDown">
                          <input class="form-input" id="contact-your-password-6" type="Password" name="password" data-constraints="@Required">
                          <label class="form-label" for="contact-your-password-6">Password*</label>
                          </div>
                    ...
                    <div class="form-wrap wow slideInDown">
                      <button class="button button-lg button-primary button-winona wow fadeInRight" type="submit">Start your jorney</button>
