...
<tbody>';
    $res = $conn->query("SELECT * FROM cart ");
      ...
      $res2 = $conn->query("SELECT sum(price) as TP FROM cart "); 
      while( $rec2 = $res2->fetch(PDO::FETCH_OBJ) )
{echo '<tr>
<th scope="row"></th>
<td></td>
<td> </td>
<td>total Price= ',$rec2->TP,'</td>
</tr>
</tbody>
</table>';}
...
<a class="button button-xs button-primary button-winona" href="order.php" >Confirm your order</a>
<a class="button button-xs button-primary button-winona" href="del.php">Reset</a>
</form>
