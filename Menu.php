    ...
    <div class="page">
      ...
      <section class="bg-gray-7">
        <div class="breadcrumbs-custom box-transform-wrap context-dark">
          <div class="container">
            <h3 class="breadcrumbs-custom-title">Our Menu</h3>
...
echo'<div class="container"><h3 class="oh"><span class="d-inline-block wow slideInUp" data-wow-delay="0s" style="padding: 10px;
margin: 15%;">  Salad </span></h3> </div>';
...
echo'<div class="container"><h3 class="oh"><span class="d-inline-block wow slideInUp" data-wow-delay="0s" style="padding: 10px;
margin: 15%;">  pizza </span></h3> </div>';

    $res = $conn->query("SELECT * FROM menu where type_menu='pizza' ");
      while( $rec = $res->fetch(PDO::FETCH_OBJ) )
      { 
        echo'
        <article class="product wow fadeInLeft" data-wow-delay=".1s" style="display: inline-block;
...
echo'<div class="container"><h3 class="oh"><span class="d-inline-block wow slideInUp" data-wow-delay="0s" style="padding: 10px;
margin: 15%;">  burger </span></h3> </div>';

    $res = $conn->query("SELECT * FROM menu where type_menu='burger' ");
      while( $rec = $res->fetch(PDO::FETCH_OBJ) )
      { 
        echo'
        <article class="product wow fadeInLeft" data-wow-delay=".1s" style="display: inline-block;
